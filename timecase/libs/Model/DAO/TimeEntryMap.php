...
class TimeEntryMap implements IDaoMap
{
	...
	public static function GetFieldMaps()
	{
		...
		if ($fm == null)
		{
			...
			$fm["Onsite"] = new FieldMap("Onsite","time_entries","onsite",false,FM_TYPE_INT,1,null,false);
			$fm["Att"] = new FieldMap("Att","time_entries","att",false,FM_TYPE_TEXT,null,null,false);
		}
		return $fm;
	}
